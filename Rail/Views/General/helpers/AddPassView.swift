...
struct AddPassView: View {
    ...
    private var emptyFilterTitle: String {
        switch pass_filter {
        case .all:
            return String(localized: "No passes")
        case .active:
            return String(localized: "No active passes")
        case .expired:
            return String(localized: "No expired passes")
        }
    }
    ...
    private var emptyFilterDescription: String {
        switch pass_filter {
        case .all:
            return String(localized: "Add a new pass using the button below.")
        case .active:
            return String(localized: "Change the filter to All or Expired to see other passes.")
        case .expired:
            return String(localized: "Change the filter to All or Active to see other passes.")
        }
    }
